...
public class Grafica<T> implements Coleccion<T> {
    ...
    private void recorreYActua(T elemento, AccionVerticeGrafica<T> accion, MeteSaca<Vertice> ms) {
      ...
      private String recorreAristas(T elemento, MeteSaca<Vertice> ms) {
        Vertice v = this.busca(elemento), av;
        this.paraCadaVertice((x) -> x.setColor(Color.NINGUNO));
        ms.mete(v);
        String cadena="";
        v.color = Color.NEGRO;
    ...
    public String bfsAristas(T elemento) {
        Cola<Vertice> cola = new Cola<Vertice>();
        String a=recorreAristas(elemento, cola);
        return a;
    }
    /**
